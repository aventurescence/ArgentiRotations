...
[Api(4)]
public sealed class DRK_DefaultCustom : DarkKnightRotation
{
    ...
    protected override bool DefenseSingleAbility(IAction nextGCD, out IAction? act)
    {
        ...
        //if (DeliriumPvE.Cooldown.IsCoolingDown && !DeliriumPvE.Cooldown.ElapsedAfter(50) && DeliriumPvE.Cooldown.ElapsedAfter(15))
        {
            //10
            if (TheBlackestNightPvE.CanUse(out act)) return true;
