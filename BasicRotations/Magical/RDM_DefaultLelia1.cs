...
[Api(4)]
public sealed class RDM_DefaultLow : RedMageRotation
{
    ...
    //No bugs in this section (mostly$2122). Extra Methods is fucked up tho, need to good look of experienced rotation dev.
